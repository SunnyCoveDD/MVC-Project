        ...
        <div class="col-6 border border-1 rounded-2 mt-2 p-2">
            <form action="" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Фамилия Имя Отчество" required id="inputName">
                </div>
                <div class="mb-3">
                    <label for="inputLogin" class="form-label">Ваше логин</label>
                    <input type="text" name="login" class="form-control" placeholder="Укажите логин:" required id="inputLogin">
                </div>
                <div class="mb-3">
                    <label for="inputPassword" class="form-label">Ваше пароль</label>
                    <input type="password" name="password" class="form-control" placeholder="Укажите пароль:" required id="inputPassword">
                </div>
                <div class="mb-3">
                    <label for="inputPasswordConfirmed" class="form-label">Подтвердите пароль</label>
                    <input type="password" name="passwordConfirmed" class="form-control" placeholder="Укажите пароль повторно:" required id="inputPasswordConfirmed">
                </div>
